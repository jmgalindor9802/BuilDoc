...
<body style="height: 100vh; display: flex; flex-direction: column; overflow: hidden;">
  ...
  <div class="row flex-grow-1">
    ...
    <div class="col-10 border-left custom-form">
      ...
      <h4 class="mb-3 custom-form">Actualizar usuario</h4>
      <div class="col-12 custom-form vh-80">
      <form id="formActualizarUsuario" class="needs-validation" method="post" action="actualizar_usuario.php"
        onsubmit="actualizarUsuario()" novalidate>
          <?php
          ...
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input name="ActEPS" type="text" class="form-control" id="eps" placeholder="Nombre EPS" 
              value="<?php echo $row['usuNombre_eps']; ?>" required>
            ...
            <div class="col-md-6">
              ...
              <input name="ActARL" type="text" class="form-control" id="arl" placeholder="Nombre ARL" 
              value="<?php echo $row['usuNombre_arl']; ?>" required>
              <div class="invalid-feedback">
            ...
            <div class="col-md-6">
              ...
              <select name="ActMunicipio" class="form-select" id="municipio" required>
                  <option value="<?php echo $row['usuMunicipio']; ?>">Elegir...</option>
              </select>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <div class="input-group has-validation">
                <input name="ActDireccion" type="text" class="form-control" id="direccion"
                  placeholder="Dirección residencia" 
                  value="<?php echo $row['usuDireccion_residencia']; ?>" required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-6">
              ...
              <div class="input-group has-validation">
                <input name="ActCorreo" type="email" class="form-control" id="Correo" placeholder="Correo electrónico"
                value="<?php echo $row['usuCorreo']; ?>" required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-6">
              ...
              <div class="input-group has-validation">
                <input name="ActTelefono" type="number" class="form-control" id="teléfono"
                  placeholder="Número teléfonico" 
                  value="<?php echo $row['usuTelefono']; ?>" required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-6">
              ...
              <div class="input-group has-validation">
                <input name="ActContrasenia" type="password" class="form-control" id="Contraseña"
                  placeholder="Contraseña usuario" 
                  value="<?php echo $row['usuContrasenia']; ?>" required>
                <div class="invalid-feedback">
...
<script src="actualizar_usuario_form.js"></script>
