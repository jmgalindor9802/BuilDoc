            ...
            <tr>
              ...
              <td><button class="btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="eliminarReporteIncidente.php?Id_recuperadoIncidente=<?php echo $Resultado['pk_id_inspeccion'];?>" class="dropdown-item text-danger" href="#">Quitar <svg xmlns="http://www.w3.org/2000/svg"
