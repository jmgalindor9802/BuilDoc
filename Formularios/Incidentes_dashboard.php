      ...
      <div class="table-responsive vh-80">
        ...
        <table id="Tabla_incidentes" class="table table-striped table-hover sticky-header">
          ...
          <tbody>
            ...
            ?>
            <tr>
              <td><?php echo $Resultado['incNombre']?></td>
              <td><?php echo $Resultado['incEstado']?></td>
              <td><?php echo $Resultado['incGravedad']?></td>
              <td><?php echo $Resultado['proNombre']?></td>
              <td><?php echo $Resultado['incFecha']?></td>
