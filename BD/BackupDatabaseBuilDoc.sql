...
usuRuta_firma varchar (280) null);
create table rol (
...
arcRuta varchar (280) not null,
arcTipo varchar (45) not null, 
arcTamaño varchar (45) not null,
arcEtiqueta varchar (20) not null,
fk_id_usuario BIGINT (20) not null,
...
tarEstado ENUM ("PENDIENTE","EN PROGRESO", "COMPLETADO") not null,
